...
def footer(canvas, doc):
    ...
    canvas.drawString(20*mm, 10*mm, "Stark & Hoffmann Immobilien GmbH | Wiesdorfer Platz 19 | 51373 Leverkusen")
...
make_pdf(
    ...
    "Nach der Checkliste von Roman Becker, regional angepasst für Eigentümer in Leverkusen. Haken Sie ab, was bereits vorliegt; offene Unterlagen lassen sich anschließend gezielt beschaffen.",
    [
...
make_pdf(
    ...
    ["Immobilienwertermittlungsverordnung (ImmoWertV): https://www.gesetze-im-internet.de/immowertv_2022/", "Gutachterausschuss Leverkusen: https://gars.nrw/leverkusen/produkte-lev/grundstuecksmarktbericht-lev"],
)
...
make_pdf(
    ...
    ["Bundesnotarkammer - Informationen zum Immobilienkaufvertrag: https://www.notar.de/themen/immobilien", "Stark & Hoffmann Immobilien - Verkaufsfahrplan: https://leverkusen-makler.de/#fahrplan"],
)
