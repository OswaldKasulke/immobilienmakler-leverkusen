...
export const metadata: Metadata = {
  title: "Datenschutzerklärung | Stark & Hoffmann Immobilien Leverkusen",
  description: "Datenschutzerklärung von Stark & Hoffmann Immobilien für leverkusen-makler.de: verantwortliche Stelle, Hosting, Kontakt- und Bewertungsformular, externe Inhalte und Ihre Rechte.",
...
export default function DatenschutzPage(){
  ...
  return <main className="legal-page">
    ...
    <section className="legal-content section">
      ...
      <p>Leverkusener Showroom: Wiesdorfer Platz 19, 51373 Leverkusen<br/>Telefon: <a href="tel:+4922049147881">+49 2204 914 7881</a><br/>E-Mail: <a href="mailto:leverkusen@evernest.com">leverkusen@evernest.com</a></p>
      ...
      <p>Auf der Startseite und auf den Stadtteilseiten zeigen wir Objektbilder, die vom Bildserver <span className="nowrap">images.ctfassets.net</span> (Contentful GmbH) geladen werden. Beim Nachladen dieser Bilder wird Ihre IP-Adresse an den Anbieter übertragen.</p>
      ...
      <p>Für Anliegen zum Datenschutz erreichen Sie uns unter <a href="mailto:leverkusen@evernest.com">leverkusen@evernest.com</a>.</p>
