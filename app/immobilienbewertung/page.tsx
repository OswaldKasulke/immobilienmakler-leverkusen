...
export default function BewertungPage(){
  ...
  return <main className="bewertung-page">
    ...
    <section className="faq-section section" id="faq"><div className="section-head"><div><p className="eyebrow">Häufige Bewertungsfragen</p><h2>Preis und Wert richtig einordnen.</h2></div><p>Kurze Antworten für Eigentümer in Leverkusen und allen 13 Stadtteilen.</p></div><div className="faq-grid">{faqs.map(([question,answer])=><details className="faq-item" key={question}><summary>{question}<span>+</span></summary><div><p>{answer}</p></div></details>)}</div><p className="editorial-note">Redaktionell geprüft durch Stark &amp; Hoffmann Immobilien GmbH · Datengrundlage Grundstücksmarktbericht der Stadt Leverkusen 2026.</p></section>
