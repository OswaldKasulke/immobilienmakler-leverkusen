...
const faqs: Array<[string,string]> = [
  ["Was ist meine Immobilie in Leverkusen wert?", "Der Rechner ordnet die vollständige Adresse einer amtlichen Immobilienrichtwertzone zu und passt deren Richtwert mit den amtlich veröffentlichten Merkmalen an. Das Ergebnis ist eine unverbindliche Ersteinschätzung und ersetzt keine Besichtigung."],
  ...
  ["Wie wird der Wohnungswert ermittelt?", "Ausgangspunkt ist der Immobilienrichtwert der konkreten amtlichen Zone. Der Rechner wendet anschließend die amtlich veröffentlichten Umrechnungswerte auf Ihre Angaben an."],
