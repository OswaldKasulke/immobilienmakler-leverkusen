...
export const metadata: Metadata = {
  title: "Allgemeine Geschäftsbedingungen | Stark & Hoffmann Immobilien Leverkusen",
  description: "Allgemeine Geschäftsbedingungen der Stark & Hoffmann Immobilien GmbH für Maklerleistungen in Leverkusen.",
  alternates: { canonical: url },
};

export default function AgbPage() {
  const schema = graphSchema(businessSchema, breadcrumbSchema([{ name: "Startseite", url: `${siteUrl}/` }, { name: "AGB", url }]));
  return <main className="legal-page">
    <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />
    <header className="site-header"><a className="brand" href="/" aria-label="Startseite"><span className="brand-mark">S<span>&amp;</span>H</span><span><strong>Stark &amp; Hoffmann</strong><small>Immobilien · Leverkusen</small></span></a><a className="header-cta" href="/immobilienbewertung/">Kostenlose Bewertung</a></header>
    ...
    <section className="legal-content section">
      <article>
        <p className="legal-version">Stand: September 2026</p>
